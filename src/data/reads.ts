...
export function getYObject<T extends z.ZodObject<any>>(
  map: Y.Map<unknown>,
  key: string,
  type: T,
): TypeOf<T> {
...
export function queryYjs<T extends z.ZodObject<any>>(
  map: Y.Map<unknown>,
  type: T,
  queries: object[],
): TypeOf<T>[] {
...
export function parseMapData<T extends z.ZodObject<any>>(
  obj: Y.Map<unknown>,
  type: T,
): TypeOf<T> {
